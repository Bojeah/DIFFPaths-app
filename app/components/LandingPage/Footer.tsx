...
const Footer = () => (
  <footer className="w-full bg-gray-100 border-t border-gray-200">
    <div className="max-w-6xl mx-auto px-4 py-8 md:py-10">
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 sm:gap-6 text-center sm:text-left">
        <div>
          <div className="flex flex-col sm:flex-row items-center sm:items-start justify-center sm:justify-start">
            <Image
              ...
              height={40}
            />
            <h2 className="text-xl font-bold text-gray-800 mt-2 sm:mt-0 sm:ml-4">
              DIFFPaths
            </h2>
          </div>
        ...
        <div className="mt-6 sm:mt-0">
          ...
          <ul className="mt-3 space-y-2 text-sm">
            <li>
              <a href="#" className="hover:text-gray-900 text-gray-700 transition-colors">
                About Us
              </a>
            </li>
            <li>
